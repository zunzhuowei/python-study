...
class ViedeoCrawler():
    def __init__(self):
        self.url = "https://btt402.com/?s=vod-read-id-6914.html"
        self.down_path = r"D:\SpiderVideoSpiderDOWN"
        self.final_path = r"D:\SpiderVideoSpiderFINAL"
        try:
    ...
    def run(self):
        ...
        #realAdr = bsObj.select("#page-container > div.content > div:nth-child(5) > div > div.video-info.col-md-5.col-xs-12.m-b-10 > div.addr > div:nth-child(1) > div.text > input")[0].get("value")
        realAdr = bsObj.select("#myVideo_html5_api")
        ...
        uriList = self.get_uri_from_m3u8("https://video1.hsanhl.com/20191206/9IM3WEy2/1000kb/hls/index.m3u8")
        i = 1   # count
        for key in uriList:
            if i%50==0:
                print("休眠10s")
            ...
            if i%120==0:
                ...
                proxies = self.get_random_ip(ip_list)
            try:
                resp = requests.get("https://d1njtfvbx1we7f.cloudfront.net/20191206/9IM3WEy2/1000kb/hls/" + key.uri, headers = self.headers, proxies=proxies)
...
# if __name__=='__main__':
#     url = "https://btt402.com/?s=vod-read-id-6914.html"
#     down_path = r"D:\SpiderVideoSpiderDOWN"
#     final_path = r"D:\SpiderVideoSpiderFINAL"
#     #name = re.findall(r'/[A-Za-z]*-[0-9]*', url)[0][1:]
#     name = "uncensord"
#     path = "copy/b %s\*.ts %s\%s.mp4" % (down_path, final_path, name)
#     os.system(path)
